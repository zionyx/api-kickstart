...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y -q curl libssl-dev python-all wget vim python-pip php5 php5-curl ruby-dev nodejs-dev npm php-pear php5-dev ruby perl5 
